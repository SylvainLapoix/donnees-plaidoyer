...
Des échanges et collaborations avec de nombreuses ONGs et OSCs dans des domaines variés (environnementaux, justice sociale, droits des femmes, aide au développement, syndicats ...) nous ont permis d'identifier plusieurs freins structurels à la mobilisation de la donnée dans la démarche de plaidoyer :
...
5. l'absence de compétences internes (ou dans des postes liés au budget ou à la communauté)
6. la difficulté de budgeter ces dépenses.

--

Au croisement de ces difficultés, un facteur commun ou agravant nous apparaît de manière critante : **.red[le manque courant d'une véritable culture de la donnée dans les organisations]**.
...
Outre la diversité des sujets et des usages attendus, les typologies de recherche de données que nous avons pu identifier au travers les besoins de plaidoyer des ONGs variaient suivant trois paramètres :
...
Les critères de recherche sont clairs mais la source est vaste et trop abondante pour être traitée manuellement.
...
Les informations à trouver sont bien déterminée mais les sources sont multiples en formats et en organisation : au temps de recherche manuel s'ajoute des modalités de comparaison.
...
La forme des information à récolter est définie mais aucune source n'est constituée a priori : des sources existent de manière disparate sans forcément de référentiel commun, ni de standard (articles de presse, publications officielles, post sur les réseaux sociaux, etc.)
...
Le type d'information à collecter n'est pas clairement définie dans sa forme et la nature des sources possibles non plus. Le problème n'est plus seulement ici de réaliser la recherche mais d'établir la forme des données existantes sur le sujet et d'établir le périmètre de recherche pour les trouver.
...
## Des briques pour faire du sur mesure



---

## Brique 1 : formation - sensibilisation
...
## Brique 2 : conciergerie de données
...
## Brique 3 : outillage de recherche
...
## Brique 4 : outillage de plaidoyer
...
## Brique 5 : production de supports et contenus
...
* on peut faire un devis sur mesure
* un ou plusieurs briques
* 


---

## La touche Datactivist

* on mange notre propre pâté vegan
* on vous fait manger votre pâté vegan
* et vous aimerez ça parce que c'est bon le pâté vegan quand c'est bien fait
...
## Business modèle de Données plaidoyer
...
background-image: url("./img/ccfdsherpa_radarddv.png")

### Le radar du devoir de vigilance
#### CCFD Terres Solidaires - Sherpa

---

# Mener un projet données plaidoyer
